                    ...
                    <v-stepper v-model="e1">
                        ...
                        <v-stepper-items>
                            ...
                            <v-stepper-content step="3">
                                <v-card class="step_cuadro mb-12" color="grey lighten-5" height="420px">
                                    <v-row>
                                        <v-col cols="4">
                            ...
                            -->
                                    ...
                                    <v-row>
                                        <v-col cols="12">
                                            <v-textarea outlined name="input-7-4" v-model="user.OBSERVACIONES" label="Observaciones" height="70px"></v-textarea>
                                            <!-- Observaciones -->
                                        </v-col>
                                    </v-row>
                                </v-card>
                        ...
                        <v-toolbar-items v-if="filtro">
                            <v-btn dark text type="submit">
                                <h3 class="text-capitalize">
                                    <v-icon class="mr-2">mdi-account-search</v-icon>Buscar
                                </h3>
                            </v-btn>
                        </v-toolbar-items>
